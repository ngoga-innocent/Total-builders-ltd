...
import AboutHeroImIage from '../../assets/about_image.jpg'
const AboutHero = () => {
  return (
    <div className='w-screen md:h-[80vh] h-[60vh] bg-cover bg-no-repeat bg-fixed text-white' style={{
      ...
      <div className='w-[80%] mx-auto flex flex-col justify-center h-[100%] gap-y-6 md:gap-y-7'> 
            ...
            <p className='md:w-[30%] text-white'>From Innovative Design to Meticulous Maintenance, We Deliver Exceptional Results Tailored to your vision.</p>
      </div>
    </div>
  )
}
