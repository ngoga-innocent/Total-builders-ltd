  ...
  return (
    <div className='w-screen md:h-[80vh] h-[60vh] bg-cover bg-no-repeat bg-fixed text-white' style={{
      ...
      <div className='w-[80%] mx-auto flex flex-col justify-center h-[100%] gap-y-6 md:gap-y-7'> 
            <h1 className='text-2xl text-white md:text-5xl md:w-[45%] leading-relaxed font-bold'>Insipire and Elevate industry standards</h1>
            <p className='md:w-[50%] text-white md:text-lg font-bold'>Setting a bencmark and pioneering advanced technological innovation.</p>
      </div>
    </div>
  )
}
