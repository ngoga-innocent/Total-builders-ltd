...
import CompanyLogo from '../../assets/housemajelogo.svg'
...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col  divide-y text-[#0F172A] not-md:text-center divide-[#0f172a]/30 w-screen bg-[#FEF9E1] py-6 md:pt-12 md:pb-6">
      ...
      <div className="w-[90%] mx-auto flex  flex-col items-center pt-4 pb-2">
        <p className="text-[#0F172A]/30 not-md:font-bold not-md:text-sm">
          copyright &copy; 2025 Total builders ltd All right reserved
        </p>
        <div className="text-xs text-gray-300 gap-x-1 flex flex-row items-center">
        <p>powered by</p>
        <img src={CompanyLogo} alt="House Major" />
        {/* <p>House Major Rwanda</p> */}
        </div>
      </div>
    </div>
  );
